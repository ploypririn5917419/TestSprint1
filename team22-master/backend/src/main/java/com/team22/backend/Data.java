        ...
        return args -> {
            ...
            Stream.of("Sunvo", "Ploy", "Ao").forEach(cusName -> {
                ...
                if (cusName == "Sunvo") {
                    ...
                    customerdb.setCustomerPhone("0881111111");
                    customerdb.setCustomerGender("Male");
                    // customerdb.setCustomerBirthday(19:11:1997);
                    customerRepository.save(customerdb);
                }
                    ...
                    customerdb.setCustomerPassword("123456");
                    customerdb.setCustomerPhone("0882222222");
                    customerdb.setCustomerGender("Female");
                    // customerdb.setuCustomerBirthday(12:01:1999);
                    customerRepository.save(customerdb);
                }
                else if(cusName == "Ao"){
                    ...
                    customerdb.setCustomerPassword("123456");
                    customerdb.setCustomerPhone("0883333333");
                    customerdb.setCustomerGender("Male");
                    // customerdb.setuCustomerBirthday(02:09:1989);
                    customerRepository.save(customerdb);
                }
